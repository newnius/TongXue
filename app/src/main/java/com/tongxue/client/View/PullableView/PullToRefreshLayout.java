...
public class PullToRefreshLayout extends RelativeLayout{
    ...
    public TextView refreshResultTextView;
    ...
    public void refreshFinish(int refreshResult){
        ...
        LearnApplication.preferences.edit().putLong(UPDATED_AT + mId, System.currentTimeMillis()).commit();
        switch (refreshResult){
            case SUCCEED:
                ...
                refreshStateImageView.setBackgroundResource(R.drawable.succeed);
                refreshResultTextView.setVisibility(View.VISIBLE);
                refreshResultTextView.setText("加载成功");
                break;
            case FAIL:
            default:
                // 刷新失败
                ...
                updateAt.setVisibility(View.GONE);
                refreshStateImageView.setVisibility(View.VISIBLE);
                refreshStateImageView.setBackgroundResource(R.drawable.failed);
                refreshResultTextView.setVisibility(View.VISIBLE);
                refreshResultTextView.setText("加载失败");
                break;
        }
        if (pullDownY > 0){
            // 刷新结果停留1秒
    ...
    public void loadmoreFinish(int refreshResult){
        ...
        switch (refreshResult){
            ...
            case FULL:
                //没有更多
                loadStateImageView.setVisibility(View.VISIBLE);
                loadStateTextView.setText(R.string.load_full);
                loadStateImageView.setBackgroundResource(R.drawable.succeed);
                break;
            case FAIL:
            default:
    ...
    private void changeState(int to){
        ...
        switch (state){
            case INIT:
                ...
                refreshResultTextView.setVisibility(View.GONE);
    ...
    /**更新时间，Added by Super pan*/
    private void refreshUpdatedAtValue() {
        lastUpdateTime = LearnApplication.preferences.getLong(UPDATED_AT + mId, -1);
    ...
    private void initView(){
        ...
        refreshStateImageView = refreshView.findViewById(R.id.result_iv);
        updateAt = (TextView) refreshView.findViewById(R.id.updateAt);
        refreshResultTextView=(TextView)refreshView.findViewById(R.id.result_tv);
        // 初始化上拉布局
