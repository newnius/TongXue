...
public class QaInfoActivity extends BaseActivity {
    @Bind(R.id.img)          RoundImageView imgIv;
    @Bind(R.id.asker)        TextView askerTv;
    @Bind(R.id.qaTime)       TextView qaTimeTv;
    @Bind(R.id.brief)        TextView briefTv;
    @Bind(R.id.detail)       TextView detailTv;
    @Bind(R.id.qaLan)        TextView qaLanTv;
    @Bind(R.id.qaDing)       TextView qaDingTv;
    @Bind(R.id.ding)         LinearLayout dingLayout;
    @Bind(R.id.ansTv)        TextView ansTv;
    @Bind(R.id.ansListView)  NoScrollListView ansListView;
    @Bind(R.id.toanswer)     TextView toanswerTv;
    @Bind(R.id.ansEt)        EditText ansEt;
    @Bind(R.id.submitAns)    Button submitAns;
    @Bind(R.id.back)         ImageView back;
    @Bind(R.id.progressBar)  ProgressBar progressBar;
    @Bind(R.id.cLayout)      RelativeLayout cLayout;
    public int qaId;
    public int index;
    public int ansNum;
